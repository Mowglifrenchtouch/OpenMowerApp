                    ...
                    children: [
                      ...
                      Opacity(
                        ...
                        child: Joystick(
                          ...
                          onStickDragEnd: () {
                            final current = remoteControl.joystickCommand.value;
                            remoteControl.joystickCommand.value =
                                JoystickCommand(0, 0, current.rx, current.ry);
                          },
                          listener: (details) {
                            final current = remoteControl.joystickCommand.value;
                            remoteControl.joystickCommand.value =
                                JoystickCommand(
                                  -details.x * 1.0, // LX free use
                                  -details.y * 1.0, // LY
                                  current.rx,
                                  current.ry,
                                );
                      ...
                      Opacity(
                        ...
                        child: Joystick(
                          ...
                          onStickDragEnd: () {
                            final current = remoteControl.joystickCommand.value;
                            remoteControl.joystickCommand.value =
                                JoystickCommand(current.lx, current.ly, 0, 0);
                          },
                          listener: (details) {
                            final current = remoteControl.joystickCommand.value;
                            remoteControl.joystickCommand.value =
                                JoystickCommand(
                                  current.lx,
                                  current.ly,
                                  -details.x * 1.0, // RX (twist)
                                  -details.y * 1.0, // RY (free use)
                                );
                          },
                        ),
                      ),
